...
- [x] 9-2. MascotCharacter コンポーネント（地図右下固定）
- [x] 9-3. App.tsx を AppLayout に組み込む・既存コンポーネントを配置
- [x] 9-4. CastlePinHoverCard コンポーネント（ピンホバー時のサムネイルポップアップ）
- [x] 9-5. 管理モード：城のサムネイル写真を設定する機能
